...
void getUnitCylinder(std::vector<glm::vec3> &positions, std::vector<glm::vec3> &normals, const unsigned int &slices)
{
	...
	for(int i = 0; i < number_of_vertices; i += 12) {
		//Bottom triangle
		positions[i] = glm::vec3(0.0,0.0,0.0);
		positions[i+1] = glm::vec3(cos(angle_step*i/12),sin(angle_step*i/12),0.0);
		positions[i+2] = glm::vec3(cos(angle_step*(i+12)/12),sin(angle_step*(i+12)/12),0.0);

		normals[i] = glm::vec3(0.0,0.0,-1.0);
		normals[i+1] = glm::vec3(0.0,0.0,-1.0);
		normals[i+2] = glm::vec3(0.0,0.0,-1.0);

		normals[i] = getNormal(positions[i], positions[i+1], positions[i+2]);
		normals[i+1] = normals[i];
		normals[i+2] = normals[i];

		//Face triangle 1
		positions[i+3] = glm::vec3(cos(angle_step*i/12),sin(angle_step*i/12),0.0);
		positions[i+4] = glm::vec3(cos(angle_step*(i+12)/12),sin(angle_step*(i+12)/12),0.0);
		positions[i+5] = glm::vec3(cos(angle_step*i/12),sin(angle_step*i/12),1.0);

		// Normal parametric version
		normals[i+3] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);
		normals[i+4] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);
		normals[i+5] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);

		// Normal cross product version
		normals[i+3] = getNormal(positions[i+3], positions[i+4], positions[i+5]);
		normals[i+4] = normals[i+3];
		normals[i+5] = normals[i+3];

		//Face triangle 2
		positions[i+6] = glm::vec3(cos(angle_step*(i+12)/12),sin(angle_step*(i+12)/12),0.0);
		positions[i+7] = glm::vec3(cos(angle_step*(i+12)/12),sin(angle_step*(i+12)/12),1.0);
		positions[i+8] = glm::vec3(cos(angle_step*(i)/12),sin(angle_step*(i)/12),1.0);

		normals[i+6] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);
		normals[i+7] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);
		normals[i+8] = glm::vec3(cos(angle_step*(i+6)/12),sin(angle_step*(i+6)/12),0.0);

		normals[i+6] = getNormal(positions[i+6], positions[i+7], positions[i+8]);
		normals[i+7] = normals[i+6];
		normals[i+8] = normals[i+6];

		//Top triangle
		positions[i+9] = glm::vec3(0.0,0.0,1.0);
		positions[i+10] = glm::vec3(cos(angle_step*(i+12)/12),sin(angle_step*(i+12)/12),1.0);
		positions[i+11] = glm::vec3(cos(angle_step*(i)/12),sin(angle_step*(i)/12),1.0);

		normals[i+9] = glm::vec3(0.0,0.0,1.0);
		normals[i+10] = glm::vec3(0.0,0.0,1.0);
		normals[i+11] = glm::vec3(0.0,0.0,1.0);

		normals[i+9] = getNormal(positions[i+9], positions[i+10], positions[i+11]);
		normals[i+10] = normals[i+9];
		normals[i+11] = normals[i+9];
	}
}
